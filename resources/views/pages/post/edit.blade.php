    ...
    <section class="pt-0 pb-0">
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('posts.update',Crypt::encrypt($post->id)) }}" method="post" enctype="multipart/form-data"> {{ method_field('PUT') }}
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="title" class="form-label">Enter Title of the Post <span class="text-danger">*</span></label>
                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" required value="{{ old('title',$post->title) }}" placeholder="Enter a title for the post">
                                @error('title')
                            ...
                            <div class="col-sm-12 mt-2">
                                ...
                                <textarea name="description" required id="PostBox" class=" @error('description') is-invalid @enderror" placeholder="Kindly Write your Post Here.">{{ old('description',$post->description) }}</textarea>
                                @error('tags')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
